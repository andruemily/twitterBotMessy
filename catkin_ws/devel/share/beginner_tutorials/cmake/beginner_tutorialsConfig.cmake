...
if("TRUE" STREQUAL "TRUE")
  set(beginner_tutorials_SOURCE_PREFIX /home/local/CORNELL-COLLEGE/bhixsonsimeral16/catkin_ws/src/beginner_tutorials)
  set(beginner_tutorials_DEVEL_PREFIX /home/local/CORNELL-COLLEGE/bhixsonsimeral16/catkin_ws/devel)
  ...
  set(beginner_tutorials_INSTALL_PREFIX /home/local/CORNELL-COLLEGE/bhixsonsimeral16/catkin_ws/install)
...
if(NOT "/home/local/CORNELL-COLLEGE/bhixsonsimeral16/catkin_ws/devel/include " STREQUAL " ")
  set(beginner_tutorials_INCLUDE_DIRS "")
  set(_include_dirs "/home/local/CORNELL-COLLEGE/bhixsonsimeral16/catkin_ws/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Brian ;The;Handsome;Hisxon" Hixson-Simeral <bhixsonsimeral16@cornellcollege.edu>"' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/local/CORNELL-COLLEGE/bhixsonsimeral16/catkin_ws/src/beginner_tutorials/${idir}'.  Ask the maintainer 'Brian ;The;Handsome;Hisxon" Hixson-Simeral <bhixsonsimeral16@cornellcollege.edu>"' to fix it.")
    endif()
